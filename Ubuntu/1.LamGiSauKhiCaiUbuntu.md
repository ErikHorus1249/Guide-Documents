...
## lời nói đầu : 
 Xin chào, xin tự giới thiệu mình là **Tuấn Anh** hay biết đến nhiều hơn với nickname là **Erik Horus**, hiện tại mình đang là sinh viên tại **học viện Công nghệ Bưu chính Viễn thông**. Là sinh viên ngành An toàn thông tin, cơ duyên đến với linux hay cụ thể là Ubuntu và Kali linux rất tình cơ khi mình tham gia phòng lab của một giảng viên trong trường tuy nhiên thì mình đã bỏ không lâu sau đó (vì kiến thức lúc đó còn lười và  ham chơi ). Phòng lab nghiên cứu chủ yếu là IOT và big data, nhiệm vụ đầu tiên tại phòng lab là cài Ubuntu cụ thể **18.04 LTS**. Mình bắt nhịp với máy tính khá muộn đó là khi vào đại học mới tiếp xúc nhiều với máy tính  mọi thứ đều khó khăn ngay cả khi dùng **Windows** cho nên khi cài và làm việc trên **Ubuntu** mình cảm thấy rất bất tiện. Sau khoảng thời gian là 3 năm sử dụng song song Windows, Ubuntu một vài hệ điều hành base x86 như : **Phoenix OS**, **Prime OS** (để chơi game mobile) thì mình đã chọn Ubuntu là hệ điều hành chính. Những thứ bất tiện ban đầu dần khiến mình thích Ubuntu và các distro linux hơn là Windows.  Đơn cử như là **Terminal**(Windows cũng có command line nhưng nó không hữu dụng như terminal ở linux) nó giúp mọi hoạt động và thao tác của mình nhanh và  tiện hơn ( sau này mới thấy tiện  ). Ngoài ra một lý do rất quan trọng lý giải cho việc thay Windows bằng **Ubuntu** đó là cấu hình máy tính với một "cỗ máy" với tài nguyên hạn hẹp như thiếu RAM, . . . hạn hẹp thì Ubuntu là lời giải hợp lý thay vì ra quán lắp thêm RAM( Vẫn nên khuyên bạn vẫn cần một cái máy tính với lượng RAM dư gỉa cho tác vụ hàng ngày ). Hiện giờ mình cũng đang sử dụng **Kali lunux**  không chỉ vì nó liên quan đến ngành học của mình mà nó còn rất nhẹ và nhiều công cụ chất lượng nữa. Nhưng nó là công cụ tấn công nên không an toàn bằng distro khác như Ubuntu hay Mint. Thôi dài dòng qúa rồi hãy bắt đầu nội dung chính thôi, mình sẽ liệt kê cho bạn những gì cần làm sau khi cài đặt thành công Ubuntu hay Kali linux.
## I. Cập nhật hệ  thống 
- Việc đầu tiên ngay sau khi hệ thống **restart** là cập nhập tất cả các repository và cài đặt những gói cần thiết điển hình là các lib. Nếu bạn không cập nhật sau khi cài Ubuntu. Bạn có thể sẽ gặp một số lỗi khi cài đặt phần mềm mới.
- Mở  **terminal** : 
...
- Giống như bạn chuyển một căn nhà thì mọi đồ đạc từ căn nhà cũ bạn đã đóng gói (**backup** dữ liệu) . Đây là lúc bạn chuyển chúng vào ngôi nhà mới những dịch vụ lưu trữ đám mây như Google driver, Dropbox hay Git sẽ hỗ trợ bạn. 
...
Ở một số phiên bản Ubuntu do bạn chưa **set** cài đặt ứng dụng của bên thứ 3 trong khi cài Ubuntu nên bạn phải tự cài **codec** để xem được video.
