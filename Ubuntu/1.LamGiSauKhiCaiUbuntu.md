...
Giống như bạn chuyển một căn nhà thì mọi đồ đạc từ căn nhà cũ bạn đã đóng gói (**backup** dữ liệu) . Đây là lúc bạn chuyển chúng vào ngôi nhà mới những dịch vụ lưu trữ đám mây như Google diver, Dropbox hay cả Git sẽ hỗ trợ bạn rất tốt. 
